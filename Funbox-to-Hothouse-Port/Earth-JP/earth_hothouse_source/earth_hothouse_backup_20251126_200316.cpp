    ...
    if(!bypass) {
        for (size_t i = 0; i < size; i++)
        {
            ...
            */
            ...
            overdrive.SetDrive(.4f + overdriveAmount * 0.2f);
            overdrive2.SetDrive(.4f + overdriveAmount * 0.2f);
            effectLeftOut = overdrive.Process(effectLeftOut) * (1 - overdriveAmount * .6f);
            effectRightOut = overdrive2.Process(effectRightOut) * (1 - overdriveAmount * .6f);
